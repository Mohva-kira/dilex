            ...
            <View className='flex flex-row justify-between pt-5 space-x-2'>
              ...
              <View className='w-2/3'>
                <View className='rounded-xl bg-primary-light/70 flex justify-center items-center  w-full p-4'>
                  <TouchableOpacity onPress={() => router.replace('/(root)/(product)/1')} className='rounded-full bg-black h-36 w-36 flex items-center justify-center shadow-lg shadow-primary '>
                  ...
                  <View className='mt-5'>
                    <Text onPress={() => router.replace('/(root)/(product)/1')} className='text-white text-center font-bold text-lg'> Plat 1</Text>
